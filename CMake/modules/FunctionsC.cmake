...
include(FunctionsCXX.cmake)


#-----------------------------------------------------------------------------------------------------------------------
# configure_static_c_library()
#
#
# Parameters:
#   LIBRARY_TARGET - The target created using add_library()
#-----------------------------------------------------------------------------------------------------------------------
function(configure_static_c_library LIBRARY_TARGET)
    ...
    # Add source files
    set(LIBRARY_SOURCES "${CMAKE_CURRENT_SOURCE_DIR}/include/${LIBRARY_TARGET}/${LIBRARY_TARGET}.h"
                        "${CMAKE_CURRENT_SOURCE_DIR}/src/${LIBRARY_TARGET}.c")
...
#-----------------------------------------------------------------------------------------------------------------------
# install_static_c_library()
#
#
# Parameters:
#   LIBRARY_TARGET - The target created using add_library()
#-----------------------------------------------------------------------------------------------------------------------
function(install_static_c_library LIBRARY_TARGET)
...
#-----------------------------------------------------------------------------------------------------------------------
# configure_shared_c_library()
#
#
# Parameters:
#   LIBRARY_TARGET - The target created using add_library()
#-----------------------------------------------------------------------------------------------------------------------
function(configure_shared_c_library LIBRARY_TARGET)
    # Ensure the target exists
    if(NOT TARGET ${LIBRARY_TARGET})
        message(FATAL_ERROR "Could not find LIBRARY_TARGET: ${LIBRARY_TARGET}")
    endif()
    ...
    generate_export_header(${LIBRARY_TARGET}
            EXPORT_FILE_NAME "${CMAKE_CURRENT_SOURCE_DIR}/include/${LIBRARY_TARGET}/export.h"
    )
    ...
    # Add source files
    set(LIBRARY_SOURCES
            "${CMAKE_CURRENT_SOURCE_DIR}/include/${LIBRARY_TARGET}/export.h"
            "${CMAKE_CURRENT_SOURCE_DIR}/include/${LIBRARY_TARGET}/${LIBRARY_TARGET}.h"
            "${CMAKE_CURRENT_SOURCE_DIR}/src/${LIBRARY_TARGET}.c")
...
#-----------------------------------------------------------------------------------------------------------------------
# install_shared_c_library()
#
#
# Parameters:
#   LIBRARY_TARGET - The target created using add_library()
#-----------------------------------------------------------------------------------------------------------------------
function(install_shared_c_library LIBRARY_TARGET NAMESPACE)
    configure_package_config_file(
            "${CMAKE_CURRENT_SOURCE_DIR}/cmake/${LIBRARY_TARGET}-config.cmake.in"
            "${LIBRARY_TARGET}-config.cmake"
            INSTALL_DESTINATION "${CMAKE_INSTALL_LIBDIR}/cmake/${LIBRARY_TARGET}")
    ...
    install(FILES "${CMAKE_CURRENT_SOURCE_DIR}/include/${LIBRARY_TARGET}/export.h"
            COMPONENT ${LIBRARY_TARGET}-dev
...
#-----------------------------------------------------------------------------------------------------------------------
function(build_main_c LIBRARY_TARGET NAMESPACE)
